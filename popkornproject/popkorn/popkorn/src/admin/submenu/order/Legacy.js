...
export default function Legacy() {
   ...
   useEffect(() => {
      apiCall(`/api/orderinfo/searchLegacy?searchType=${currCategoryl}&keyword=${currKeyword}&page=${currentPage}`, "GET", null, null)
         .then(response => {
            setOrderData({
      ...
      <div className="adminorderwhole">
         <div className="adminOrderlist_container">
            <div className="adminOrderlist_header">
               <TypeIt options={{ loop: false }} className="productlist_type">Legacy</TypeIt>
            </div>
         </div>
